        ...
        <main className="min-h-screen pt-32 px-4 md:px-12 pb-20 bg-[#f0f0f0]">
            ...
            <div className="mb-12 border-b border-black/10 pb-8 flex flex-col md:flex-row justify-between items-end">
                <h1 className="text-6xl md:text-[8vw] leading-[0.9] font-medium tracking-tight text-black uppercase">
                    <span dangerouslySetInnerHTML={{ __html: meta.heading || "SELECTED<br/>WORKS" }} />
                </h1>
                <div className="text-right font-mono text-xs text-gray-500 mt-4 md:mt-0">
                    ...
                    <p className="mt-2 text-black animate-pulse">{meta.metaText || "TAP ROW TO EXPAND [+]"}</p>
                </div>
            </div>
            ...
            <div className="mt-20 border-t border-black/10 pt-12 flex flex-col md:flex-row justify-between items-end gap-8">
                <div className="text-left">
                    <p className="font-mono text-xs text-gray-400 mb-2">{meta.navPrevLabel || "PREVIOUS"}</p>
                    <Link href="/about" className="text-xl md:text-2xl font-medium hover:italic transition-all inline-block">
                        {meta.navPrevText || "← About Me"}
                    </Link>
                </div>
                <div className="text-right">
                    <p className="font-mono text-xs text-gray-400 mb-2">{meta.navNextLabel || "NEXT"}</p>
                    <Link href="/cv" className="text-4xl md:text-6xl font-medium hover:italic transition-all inline-block">
